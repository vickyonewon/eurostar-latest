...
const HeroSection: React.FC = () => {
    return (
    <div className="bg-gradient-to-t from-[#1d1b1a] via-[#8A502E] to-[#1d1b1a] bg-cover bg-no-repeat pb-[0] lg:pb-[10rem]">
    <div className="flex flex-col lg:flex-row mb-[5rem] lg:pt-[6rem] relative z-[40]">
